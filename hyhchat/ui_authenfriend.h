...
public:
    ...
    void setupUi(QDialog *AuthenFriend)
    {
        ...
        scrollcontent->setGeometry(QRect(0, 0, 376, 498));
        ...
        verticalLayout_5 = new QVBoxLayout(lb_group_wid);
        ...
        verticalLayout_6 = new QVBoxLayout(input_tip_wid);
        ...
        verticalLayout_5->addWidget(input_tip_wid);
        ...
        verticalLayout_4 = new QVBoxLayout(more_lb_wid);
        ...
        more_lb->setAlignment(Qt::AlignCenter);

        verticalLayout_4->addWidget(more_lb);
        ...
        verticalSpacer = new QSpacerItem(0, 30, QSizePolicy::Minimum, QSizePolicy::Fixed);
