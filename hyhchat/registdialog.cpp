...
void RegistDialog::slot_reg_mod_finsih(ReqId id, QString res, ErrorCodes err)
{
...
void RegistDialog::initHttpHandlers()
{
    ...
    _handlers.insert(ReqId::ID_REG_USER, [this](QJsonObject jsonObj){
        ...
        qDebug()<<"user uuid id"<<jsonObj["uid"].toString();
        qDebug()<< "email is " << email ;
        ChangeTipPage();
    });
}
...
void RegistDialog::on_return_button_clicked()
{
    _countdown_timer->stop();
    emit sigSwitchLogin();
}
...
void RegistDialog::on_cancle_btn_clicked()
{
    _countdown_timer->stop();
    emit sigSwitchLogin();
}
